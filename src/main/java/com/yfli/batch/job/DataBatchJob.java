package com.yfli.batch.job;

import com.yfli.batch.entity.Access;
import com.yfli.batch.listener.JobListener;
...
public class DataBatchJob {
    ...
    public Job dataHandleJob() {
        return jobBuilderFactory.get("dataHandleJob").
                ...
                start(handleDataStep()).listener(jobListener).build();
    }
